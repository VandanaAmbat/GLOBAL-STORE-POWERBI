A global store data report Analysis have been done in this repository using POWER BI for easy and vivid understanding of the data. Various steps are done with the sales data shared in the excel sheet.
